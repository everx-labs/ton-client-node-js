...
test('crypto', async () => {
    const crypto: TONCryptoModule = TONClient.shared.crypto;
    ...
    expect(hex1).toEqual('2616a44e0da827f0244e93c2b0b914223737a6129bc938b8edf2780ac9482960baa9b7c7cdb11457c1cebd5ae77e295ed94577f32d4c963dc35482991442daa5');
    ...
    expect(result6).toEqual('52e7fcf91356eca55fc5d52f16f5d777e3521f54e3c570c9bbb7df58fc15add73994e5db42be368de7ebed93c9d4f21f9be7cc453358d734b04a057d0ed3626d');
    ...
    expect(signed).toEqual('fb0cfe40eea5d6c960652e6ceb904da8a72ee2fcf6e05089cf835203179ff65bb48c57ecf31dcfcd26510bea67e64f3e6898b7c58300dc14338254268cade10354657374204d657373616765');
    ...
    expect(sign).toEqual('fb0cfe40eea5d6c960652e6ceb904da8a72ee2fcf6e05089cf835203179ff65bb48c57ecf31dcfcd26510bea67e64f3e6898b7c58300dc14338254268cade103');
    ...
    expect(child).toEqual('xprv9uZwtSeoKf1swgAkVVCEUmC2at6t7MCJoHnBbn1MWJZyxQ4cySkVXPyNh7zjf9VjsP4vEHDDD2a6R35cHubg4WpzXRzniYiy8aJh1gNnBKv');
    expect(await crypto.hdkeyXPrvSecret(child)).toEqual('518afc6489b61d4b738ee9ad9092815fa014ffa6e9a280fa17f84d95f31adb91');
    expect(await crypto.hdkeyXPrvPublic(child)).toEqual('027a598c7572dbb4fbb9663a0c805576babf7faa173a4288a48a52f6f427e12be1');
